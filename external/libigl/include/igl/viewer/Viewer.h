...
namespace viewer
{
  ...
  public:
    ...
    // Mesh IO
    IGL_INLINE bool virtual load_mesh_from_file(const char* mesh_file_name);
    IGL_INLINE bool virtual save_mesh_to_file(const char* mesh_file_name);

    // Callbacks
    IGL_INLINE bool key_pressed(unsigned int unicode_key,int modifier);
    IGL_INLINE bool virtual key_down(int key,int modifier);
